...
public class RolesEndPointTests(ApiFactory apiFactory)
{
    ...
    [Fact]
    public async Task RolesEndPoint_WhenUserWithadminRole_ShouldReturnOk()
    {
        //Arrange
    ...
    [Fact]
    public async Task RolesEndPoint_UserWithWrongRole_ShouldReturnForbidden()
    {
        //Arrange
        string url = $"{_baseAddress}/realms/oidc/protocol/openid-connect/token";
