...
public class CustomPolicyEndPointTests(ApiFactory apiFactory)
{
    ...
    const string apiUrl = "api/custompolicy";
    ...
    [Fact]
    public async Task AuthorizeEndPoint_WhenUserIsNotAuthenticated_ShouldReturnUnauthorizedOrForbidden()
    {
        //Arrange
        //Act
        var result = await _httpClient.GetAsync(apiUrl);
